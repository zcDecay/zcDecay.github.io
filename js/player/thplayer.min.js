    ...
    $.fn.extend({
        "thplayer": function(options) {
            options = $.extend({
                ...
                music: "http://pax1y6mhm.bkt.clouddn.com/blog/music%E6%91%A9%E7%99%BB%E5%85%84%E5%BC%9F%20-%20%E8%B5%B0%E9%A9%AC%EF%BC%88Cover%EF%BC%9A%E9%99%88%E7%B2%92%EF%BC%89.mp3",
            },
            options);
            thplayer_init();
            var myaudio = document.getElementById("thaudio");
            function thplayer_init() {
                document.getElementById("Thplayer").innerHTML = "" + '<div id="player-demo">' + '   <img id="player-album" src="http://p4.music.126.net/gYwk-n_UWAtOfDZBEV04dQ==/7699879929738059.jpg">' + '   <div id="player-mask"></div>' + '   <div id="play" class="bg play-bg" data-action="play"></div>' + '   <div id="pause" class="bg pause-bg" data-action="pause"></div>' + '   <div id="player-info">' + '       <strong class="title"></strong>' + '       <span class="and">-</span> ' + '       <span class="author"></span>' + "   </div>" + '   <div id="player-control">' + '       <span class="left-time">0:00</span>' + '       <span class="and">/</span> ' + '       <span class="right-time">3:45</span>' + "   </div>" + '   <div class="player-listbox">' + '       <div style="width:100%;text-align:center;position:relative">' + '           <input type="text" id="txtSong" placeholder="请输入歌曲名称，例如：好久不见 陈奕迅..."> ' + '           <img src="./img/search.png" id="btnSearch">' + "       </div>" + '       <table class="th-list-table">' + '           <thead style="display:block;height:30px">' + '               <tr style="display:block;padding:0 20px;color:#999">' + '                   <th style="padding-right:160px">歌名</th>' + "                   <th>歌手</th>" + "               </tr>" + "           </thead>" + '           <tbody id="UserList" style="display:block;height:280px;width:330px;overflow:auto;margin-top:10px">' + "           </tbody>" + '           <tr id="LoadMore" style="display:none;cursor:pointer;text-align:center;font-size:10px;color:#565454" offset="0" search="0">' + '               <td colspan="8"></td>' + "           </tr>" + "       </table>" + "   </div>" + '   <div id="player-list-icon"></div>' + '   <div id="player-process">' + '   <div id="player-current"></div>' + "       <span></span>" + "   </div>" + "</div>" + '<div id="player-flex">' + '   <span id="player-show"></span>' + "</div>" + '<audio id="thaudio" loop></audio>';
                var myaudio = document.getElementById("thaudio");
