...
function() {
    return function(e) {
        ...
        f = ["nick", "mail", "link"],
        v = Storage && localStorage && localStorage instanceof Storage && localStorage,
        g = location.pathname.replace(/index\.(html|htm)$/, "");
        r.prototype.init = function(e) {
            ...
            try {
                ...
                t.locale = t.locale || p[e.lang || "zh-cn"],
                t.notify = e.notify || !1,
                t.verify = e.verify || !1,
                h.params = "?d=" + (i.indexOf(a) > -1 ? a: "mm"),
                h.hide = "hide" === a,
                h.cdn = !!s && s || h.cdn,
                g = e.path || g,
                e.guest_info = (e.guest_info || f).filter(function(e) {
                    return f.indexOf(e) > -1
                });
                var l = Number(e.pageSize || 10);
                if (e.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, !AV) return void setTimeout(function() {
                    t.init(e)
                },
                20);
                ...
                v = ["cn", "us"];
                if (d = v.indexOf(d) > -1 ? d: v[0], !c || !u) throw 99;
                ...
                for (var m = document.querySelectorAll(".valine-comment-count"), b = 0, x = m.length; b < x; b++) !
                function(e, n) {
                    var r = m[e];
                    if (r) {
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), o.Event.on("click", $.querySelector(".vcancel"),
                        function(e) {
                            t.alert.hide()
                        }), $.setAttribute("style", "display:block;"), e && e.type) {
                            var a = $.querySelector(".vsure");
                            o.Event.on("click", a,
                            function(n) {
                                t.alert.hide(),
                                e.cb && e.cb()
        ...
        r.prototype.Q = function(e) {
            ...
            return t.equalTo("url", decodeURI(e)),
            1 == arguments.length ? t.doesNotExist("rid") : t.equalTo("rid", arguments[1]),
        ...
        r.prototype.installLocale = function(e, t) {
            var n = this;
            return t = t || {},
            p[e] = JSON.stringify(Object.keys(p["zh-cn"])) == JSON.stringify(Object.keys(t)) ? t: void 0,
            n.locale = p[e] || p["zh-cn"],
            n
        },
        ...
        r.prototype.bind = function(e) {
            ...
            function(e, t) {
                ...
                o.Event.on("click", r,
                function(e) {
                    var n = document.querySelector(".veditor");
                    A(n, t),
                    p(n)
                })
            } (b, f[b]);
            ...
            for (var x = e.guest_info,
            y = {},
            k = {
                veditor: "comment"
            },
            w = 0, S = x.length; w < S; w++) k["v" + x[w]] = x[w];
            for (var _ in k) k.hasOwnProperty(_) &&
            function() {
                var e = k[_],
                n = t.el.querySelector("." + _);
                y[e] = n,
                n && o.Event.on("input", n,
                function(t) {
                    "comment" === e ? p(n) : d[e] = o.HtmlUtils.escape(n.value.replace(/(^\s*)|(\s*$)/g, ""))
                })
            } ();
            ...
            function(e) {
                if ("" != d.comment) {
                    O.getAttribute("v") ? (O.removeAttribute("v"), i.setAttribute("style", "display:none")) : (O.setAttribute("v", 1), r.removeAttribute("v"), n.setAttribute("style", "display:none"), i.innerHTML = d.comment, i.setAttribute("style", "display:block"), E())
                }
            });
            var A = function(e, t) {
            ...
            $ = function(e) {
                var n = t.el.querySelector(".vh[rid='" + e + "']"),
                r = n.querySelector(".vquote");
                return r || (r = document.createElement("div"), r.setAttribute("class", "vquote"), n.appendChild(r)),
                r
            },
            M = function n() {
                ...
                s.limit(i),
                s.skip((r - 1) * i),
                s.find().then(function(e) {
                    for (var l = e.length,
                    c = 0; c < l; c++) !
                    function(n) {
                        var r = e[n],
                        i = r.id;
                        C(r, t.el.querySelector(".vlist"), !0),
                        s = t.Q(g, i),
                        s.find().then(function(e) {
                            var t = e.length;
                            if (t) for (var n = 0; n < t; n++) C(e[n], $(i))
                        })
                    } (c);
                    var u = t.el.querySelector(".vpage");
                    u.innerHTML = i * r < a ? '<button type="button" class="vmore vbtn">' + t.locale.ctrl.more + "</button>": "";
                    var d = u.querySelector(".vmore");
                    d && o.Event.on("click", d,
                    function(e) {
                        u.innerHTML = "",
                        n(++r)
                    }),
            ...
            t.Q(g).count().then(function(e) {
                e > 0 ? (t.el.querySelector(".vinfo").setAttribute("style", "display:block;"), t.el.querySelector(".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments, M()) : t.loading.hide()
            }).
            catch(function(e) {
            ...
            var C = function(e, n, r) {
                ...
                i.setAttribute("class", "vcard"),
                i.setAttribute("id", e.id);
                var o = h.hide ? "": '<img class="vimg" src=\'' + (h.cdn + a(e.get("mail")) + h.params) + "'>",
                s = c(e.get("ua")),
                u = '<span class="vsys">' + s.browser + " " + s.version + "</span>",
                d = '<span class="vsys">' + s.os + " " + s.osVersion + "</span>",
                p = "",
                f = e.get("link") || "";
                ...
                for (var v = i.querySelector(".vat"), g = i.querySelectorAll("a"), m = 0, b = g.length; m < b; m++) {
                    var x = g[m];
                    x && -1 == (x.getAttribute("class") || "").indexOf("at") && (x.setAttribute("target", "_blank"), x.setAttribute("rel", "nofollow"))
                }
                var y = n.querySelectorAll(".vcard");
                r ? n.appendChild(i) : n.insertBefore(i, y[0]);
                var k = i.querySelector(".vcontent");
                k && L(k),
                v && T(v),
                E()
            },
            ...
            L = function(e) {
                setTimeout(function() {
                    e.offsetHeight > 180 && (e.classList.add("expand"), o.Event.on("click", e,
                    function(t) {
            ...
            T = function(e) {
                ...
                function(t) {
                    ...
                    q.at = o.HtmlUtils.escape(n) + " ",
                    q.rid = r,
                    q.rmail = i,
                    y.comment.setAttribute("placeholder", n),
                    y.comment.focus()
                })
            },
            z = function() {
                var e = v && v.ValineCache;
                if (e) {
                    e = JSON.parse(e);
                    var n = x;
                    for (var r in n) {
                        var i = n[r];
                        t.el.querySelector(".v" + i).value = o.HtmlUtils.unescape(e[i]),
                        d[i] = e[i]
                    }
                }
            };
            ...
            var R = function() {
                ...
                y.comment.setAttribute("placeholder", t.placeholder),
                q.at = "",
                q.rid = "",
                q.rmail = "",
                d.nick = "Anonymous",
            ...
            B = t.el.querySelector(".vsubmit"),
            U = function(e) {
                if (B.getAttribute("disabled")) return void t.alert.show({
                    type: 0,
                    text: t.locale.tips.busy + 'ヾ(๑╹◡╹)ﾉ"',
                    ctxt: t.locale.ctrl.ok
                });
                if ("" == d.comment) return void y.comment.focus();
                d.nick = d.nick || "Anonymous";
                var n = m.mail(d.mail),
                r = m.link(d.link);
                d.mail = n.k ? n.v: "",
                d.link = r.k ? r.v: "",
                t.notify || t.verify ? Q(j) : j()
            },
            P = function() {
                var e = new AV.ACL;
            ...
            j = function() {
                ...
                q.rid && (n.set("rid", q.rid), d.comment = q.at + d.comment);
                ...
                n.save().then(function(e) {
                    "Anonymous" != d.nick && v && v.setItem("ValineCache", JSON.stringify({
                        nick: d.nick,
                        link: d.link,
                        mail: d.mail
                    }));
                    ...
                    try {
                        if (q.rid) {
                            var i = t.el.querySelector('.vquote[rid="' + q.rid + '"]') || $(q.rid);
                            C(e, i, !0)
                        } else n ? (r = Number(n.innerText) + 1, n.innerText = r) : t.el.querySelector(".vcount").innerHTML = '<span class="num">1</span> ' + t.locale.tips.comments,
                        C(e, t.el.querySelector(".vlist"));
                        d.mail && I({
                            username: d.nick,
                            mail: d.mail
                        }),
                        q.at && q.rmail && t.notify && H({
                            username: q.at.replace("@", ""),
                            mail: q.rmail
                        }),
            ...
            o.Event.off("click", B, U),
            o.Event.on("click", B, U),
            o.Event.on("keyup", document,
            function(e) {
                var t = e.keyCode || e.which || e.charCode; (e.ctrlKey || e.metaKey) && 13 == t && U()
            })
        };
        var m = {
            mail: function(e) {
    ...
    function(e, t, n) {
        ...
        function(i) {
            ...
            function p(e, t) {
                ...
                a = f,
                s = v,
                p = l(p, h, f, v, e[n], 7, -680876936),
                v = l(v, p, h, f, e[n + 1], 12, -389564586),
                f = l(f, v, p, h, e[n + 2], 17, 606105819),
                h = l(h, f, v, p, e[n + 3], 22, -1044525330),
                p = l(p, h, f, v, e[n + 4], 7, -176418897),
                v = l(v, p, h, f, e[n + 5], 12, 1200080426),
                f = l(f, v, p, h, e[n + 6], 17, -1473231341),
                h = l(h, f, v, p, e[n + 7], 22, -45705983),
                p = l(p, h, f, v, e[n + 8], 7, 1770035416),
                v = l(v, p, h, f, e[n + 9], 12, -1958414417),
                f = l(f, v, p, h, e[n + 10], 17, -42063),
                h = l(h, f, v, p, e[n + 11], 22, -1990404162),
                p = l(p, h, f, v, e[n + 12], 7, 1804603682),
                v = l(v, p, h, f, e[n + 13], 12, -40341101),
                f = l(f, v, p, h, e[n + 14], 17, -1502002290),
                h = l(h, f, v, p, e[n + 15], 22, 1236535329),
                p = c(p, h, f, v, e[n + 1], 5, -165796510),
                v = c(v, p, h, f, e[n + 6], 9, -1069501632),
                f = c(f, v, p, h, e[n + 11], 14, 643717713),
                h = c(h, f, v, p, e[n], 20, -373897302),
                p = c(p, h, f, v, e[n + 5], 5, -701558691),
                v = c(v, p, h, f, e[n + 10], 9, 38016083),
                f = c(f, v, p, h, e[n + 15], 14, -660478335),
                h = c(h, f, v, p, e[n + 4], 20, -405537848),
                p = c(p, h, f, v, e[n + 9], 5, 568446438),
                v = c(v, p, h, f, e[n + 14], 9, -1019803690),
                f = c(f, v, p, h, e[n + 3], 14, -187363961),
                h = c(h, f, v, p, e[n + 8], 20, 1163531501),
                p = c(p, h, f, v, e[n + 13], 5, -1444681467),
                v = c(v, p, h, f, e[n + 2], 9, -51403784),
                f = c(f, v, p, h, e[n + 7], 14, 1735328473),
                h = c(h, f, v, p, e[n + 12], 20, -1926607734),
                p = u(p, h, f, v, e[n + 5], 4, -378558),
                v = u(v, p, h, f, e[n + 8], 11, -2022574463),
                f = u(f, v, p, h, e[n + 11], 16, 1839030562),
                h = u(h, f, v, p, e[n + 14], 23, -35309556),
                p = u(p, h, f, v, e[n + 1], 4, -1530992060),
                v = u(v, p, h, f, e[n + 4], 11, 1272893353),
                f = u(f, v, p, h, e[n + 7], 16, -155497632),
                h = u(h, f, v, p, e[n + 10], 23, -1094730640),
                p = u(p, h, f, v, e[n + 13], 4, 681279174),
                v = u(v, p, h, f, e[n], 11, -358537222),
                f = u(f, v, p, h, e[n + 3], 16, -722521979),
                h = u(h, f, v, p, e[n + 6], 23, 76029189),
                p = u(p, h, f, v, e[n + 9], 4, -640364487),
                v = u(v, p, h, f, e[n + 12], 11, -421815835),
                f = u(f, v, p, h, e[n + 15], 16, 530742520),
                h = u(h, f, v, p, e[n + 2], 23, -995338651),
                p = d(p, h, f, v, e[n], 6, -198630844),
                v = d(v, p, h, f, e[n + 7], 10, 1126891415),
                f = d(f, v, p, h, e[n + 14], 15, -1416354905),
                h = d(h, f, v, p, e[n + 5], 21, -57434055),
                p = d(p, h, f, v, e[n + 12], 6, 1700485571),
                v = d(v, p, h, f, e[n + 3], 10, -1894986606),
                f = d(f, v, p, h, e[n + 10], 15, -1051523),
                h = d(h, f, v, p, e[n + 1], 21, -2054922799),
                p = d(p, h, f, v, e[n + 8], 6, 1873313359),
                v = d(v, p, h, f, e[n + 15], 10, -30611744),
                f = d(f, v, p, h, e[n + 6], 15, -1560198380),
                h = d(h, f, v, p, e[n + 13], 21, 1309151649),
                p = d(p, h, f, v, e[n + 4], 6, -145523070),
                v = d(v, p, h, f, e[n + 11], 10, -1120210379),
                f = d(f, v, p, h, e[n + 2], 15, 718787259),
                h = d(h, f, v, p, e[n + 9], 21, -343485551),
                p = o(p, r),
                h = o(h, i),
                f = o(f, a),
                v = o(v, s);
            ...
            function g(e, t) {
                ...
                a[n] = 1549556828 ^ i[n];
                return r = p(o.concat(f(t)), 512 + 8 * t.length),
                h(p(a.concat(r), 640))
            }
            function m(e) {
            ...
            function(t) {
                ...
                function h(e, t, r) {
                    ...
                    if (r || "function" == typeof t) {
                        ...
                        for (; c < i.length; c++) !
                        function(e) {
                            "code" !== e.type ? --o || u() : l(e.text, e.lang,
                            function(t, n) {
                ...
                f.html = c(f.html).replace("comment", /<!--[\s\S]*?-->/).replace("closed", /<(tag)[\s\S]+?<\/\1>/).replace("closing", /<tag(?:"[^"]*"|'[^']*'|\s[^'"\/>\s]*)*?\/?>/).replace(/tag/g, f._tag).getRegex(),
                f.paragraph = c(f.paragraph).replace("hr", f.hr).replace("heading", f.heading).replace("lheading", f.lheading).replace("tag", "<" + f._tag).getRegex(),
                ...
                f.gfm.paragraph = c(f.paragraph).replace("(?!", "(?!" + f.gfm.fences.source.replace("\\1", "\\2") + "|" + f.list.source.replace("\\1", "\\3") + "|").getRegex(),
                f.tables = p({},
                f.gfm, {
                    nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,
                    table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/
                ...
                n.prototype.token = function(e, t) {
                    e = e.replace(/^ +$/gm, "");
                    for (var n, r, i, o, a, s, l, c, u, d, p; e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), i[0].length > 1 && this.tokens.push({
                        type: "space"
                    ...
                    this.tokens.push({
                        ...
                        this.options.smartLists && c !== d - 1 && (a = f.bullet.exec(i[c + 1])[0], o === a || o.length > 1 && a.length > 1 || (e = i.slice(c + 1).join("\n") + e, c = d - 1)),
                        r = n || /\n\n(?!\s*$)/.test(s),
                    ...
                    this.tokens.links[u] || (this.tokens.links[u] = {
                        ...
                        c = 0; c < s.align.length; c++) / ^*-+:*$ / .test(s.align[c]) ? s.align[c] = "right": /^ *:-+: *$/.test(s.align[c]) ? s.align[c] = "center": /^ *:-+ *$/.test(s.align[c]) ? s.align[c] = "left": s.align[c] = null;
                        for (c = 0; c < s.cells.length; c++) s.cells[c] = s.cells[c].replace(/^ *\| *| *\| *$/g, "").split(/ *\| */);
                        this.tokens.push(s)
                ...
                r.prototype.output = function(e) {
                    ...
                    o += this.renderer.link(r, null, n);
                        ...
                        o += this.renderer.codespan(s(i[2].trim(), !0));
                    ...
                    } else i[0] = this.rules._backpedal.exec(i[0])[0],
                    e = e.substring(i[0].length),
                    "@" === i[2] ? (n = s(i[0]), r = "mailto:" + n) : (n = s(i[0]), r = "www." === i[1] ? "http://" + n: n),
                    o += this.renderer.link(r, null, n);
                    return o
                },
